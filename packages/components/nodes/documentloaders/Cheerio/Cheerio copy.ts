...
class Cheerio_DocumentJSONandURLLoader implements INode {
    label: string
    name: string
    description: string
    type: string
    ...
    constructor() {
        this.label = 'Cheerio Web Scraper1'
        this.name = 'cheerioWebScraper1'
        this.type = 'Document'
...
module.exports = { nodeClass: Cheerio_DocumentJSONandURLLoader }
